  ...
  CREATE OR REPLACE VIEW RPRO_CUST_RI_LN_ACCT_SUMM_V ("PRD_ID", "PERIOD_NAME", "PRD_START_DT", "PRD_END_DT",
  "RC_ID", "RC_VER", "LINE_ID", "ROOT_LINE_ID", "ACCT_SEGS", "ACCT_TYPE_ID", "ACCT_TYPE", "ACCT_GROUP", 
  "DEF_REC_FLAG", "VC_FLAG", "COST_FLAG", "INCL_MANUAL_JE_FLAG", "INCL_NETTING_FLAG", "VC_CLR_FLAG", 
  "MANUAL_JE", "NETTING_ENTRY", "SCHD_TYPE", "CLIENT_ID", "BOOK_ID", "SEC_ATR_VAL", "QT_NM", "PD_YR", 
  "PD_NM", "CRTD_BY", "CRTD_DT", "UPDT_BY", "UPDT_DT", "F_TL_AT", "F_TL_AT_PS", "F_TL_AT_UN", "F_RT_AR",
  "F_AT", "F_AT_PS", "F_AT_UN", "F_AR_AT", "F_AR_PS", "F_AR_UN", "F_TL_BB", "F_TL_AD", "F_TL_RL", 
  "F_TL_EB", "F_TL_RL_PS", "F_TL_RL_UN", "F_TL_NT", "F_NT", "F_AL_NT", "F_BB", "F_AD", "F_RL", 
  "F_EB", "F_RL_PS", "F_RL_UN", "F_AL_BB", "F_AL_AD", "F_AL_RL", 
  "F_AL_EB", "F_AL_PS", "F_AL_UN", "F_TL_AT_QT", "F_AT_QT", "F_AR_AT_QT", 
  "F_RT_AR_QT", "F_TL_BB_QT", "F_TL_AD_QT", "F_TL_RL_QT", "F_BB_QT", 
  "F_AD_QT", "F_RL_QT", "F_AL_BB_QT", "F_AL_AD_QT", "F_AL_RL_QT", "F_TL_AT_YT", 
  "F_AT_YT", "F_AR_AT_YT", "F_RT_AR_YT", "F_TL_BB_YT", "F_TL_AD_YT", "F_TL_RL_YT", 
  "F_BB_YT", "F_AD_YT", "F_RL_YT", "F_AL_BB_YT", "F_AL_AD_YT", "F_AL_RL_YT", "F_TL_AT_UT", 
  "F_RV_AT_UT", "F_AR_AT_UT", "F_TL_BB_UT", "F_TL_AD_UT", "F_TL_RL_UT", "F_BB_UT", "F_AD_UT", 
  "F_RL_UT", "F_AL_BB_UT", "F_AL_AD_UT", "F_AL_RL_UT", "T_TL_AT", "T_TL_AT_PS", "T_TL_AT_UN", 
  "T_AT", "T_AT_PS", "T_AT_UN", "T_AR_AT", "T_AR_PS", "T_AR_UN", "T_RT_AR", "T_TL_BB", "T_TL_AD", 
  "T_TL_RL", "T_TL_EB", "T_TL_RL_PS", "T_TL_RL_UN", "T_TL_NT", "T_NT", "T_AL_NT", "T_BB", "T_AD", 
  "T_RL", "T_EB", "T_RL_PS", "T_RL_UN", "T_AL_BB", "T_AL_AD", "T_AL_RL", "T_AL_EB", "T_AL_PS", "T_AL_UN", 
  "T_TL_AT_QT", "T_AT_QT", "T_AR_AT_QT", "T_RT_AR_QT", "T_TL_BB_QT", "T_TL_AD_QT", "T_TL_RL_QT", "T_BB_QT", 
  "T_AD_QT", "T_RL_QT", "T_AL_BB_QT", "T_AL_AD_QT", "T_AL_RL_QT", "T_TL_AT_YT", "T_AT_YT", "T_AR_AT_YT", 
  "T_RT_AR_YT", "T_TL_BB_YT", "T_TL_AD_YT", "T_TL_RL_YT", "T_BB_YT", "T_AD_YT", "T_RL_YT", "T_AL_BB_YT", 
  "T_AL_AD_YT", "T_AL_RL_YT", "T_TL_AT_UT", "T_RV_AT_UT", "T_AR_AT_UT", "T_TL_BB_UT", "T_TL_AD_UT", "T_TL_RL_UT", 
  "T_BB_UT", "T_AD_UT", "T_RL_UT", "T_AL_BB_UT", "T_AL_AD_UT", "T_AL_RL_UT", "R_TL_AT", "R_TL_AT_PS",
  "R_TL_AT_UN", "R_RT_AR", "R_AT", "R_AT_PS", "R_AT_UN", "R_AR_AT", "R_AR_PS", "R_AR_UN", "R_TL_BB", 
  "R_TL_AD", "R_TL_RL", "R_TL_EB", "R_TL_RL_PS", "R_TL_RL_UN", "R_TL_NT", "R_NT", "R_AL_NT", "R_BB", 
  "R_AD", "R_RL", "R_EB", "R_RL_PS", "R_RL_UN", "R_AL_BB", "R_AL_AD", "R_AL_RL", "R_AL_EB", "R_AL_PS",
  "R_AL_UN", "R_TL_AT_QT", "R_AT_QT", "R_AR_AT_QT", "R_RT_AR_QT", "R_TL_BB_QT", "R_TL_AD_QT",
  "R_TL_RL_QT", "R_BB_QT", "R_AD_QT", "R_RL_QT", "R_AL_BB_QT", "R_AL_AD_QT", "R_AL_RL_QT",
  "R_TL_AT_YT", "R_AT_YT", "R_AR_AT_YT", "R_RT_AR_YT", "R_TL_BB_YT", "R_TL_AD_YT", "R_TL_RL_YT",
  "R_BB_YT", "R_AD_YT", "R_RL_YT", "R_AL_BB_YT", "R_AL_AD_YT", "R_AL_RL_YT", "R_TL_AT_UT", 
  "R_RV_AT_UT", "R_AR_AT_UT", "R_TL_BB_UT", "R_TL_AD_UT", "R_TL_RL_UT", "R_BB_UT", "R_AD_UT", 
  "R_RL_UT", "R_AL_BB_UT", "R_AL_AD_UT", "R_AL_RL_UT", "F_UNBL_AT", "F_UNBL_PS", "F_UNBL_UN",
  "F_UNBL_AT_QT", "F_UNBL_AT_YT", "F_UNBL_AT_UT", "T_UNBL_AT", "T_UNBL_PS", "T_UNBL_UN",
  "T_UNBL_AT_QT", "T_UNBL_AT_YT", "T_UNBL_AT_UT", "R_UNBL_AT", "R_UNBL_PS", "R_UNBL_UN",
  "R_UNBL_AT_QT", "R_UNBL_AT_YT", "R_UNBL_AT_UT","T_CONTRA_RL_UT","F_CONTRA_RL_UT","R_CONTRA_RL_UT",
  "F_RT", "F_AR_RT", "T_RT", "T_AR_RT", "R_RT", "R_AR_RT", "T_TL_NT_RL", "F_TL_NT_RL", "R_TL_NT_RL",
  "T_NT_RL", "F_NT_RL", "R_NT_RL", "T_AL_NT_RL", "F_AL_NT_RL", "R_AL_NT_RL", "T_TL_CA_IM", "F_TL_CA_IM",
  "R_TL_CA_IM", "T_TL_CA_IM_QT", "F_TL_CA_IM_QT", "R_TL_CA_IM_QT", "T_TL_CA_IM_YT", "F_TL_CA_IM_YT",
  "R_TL_CA_IM_YT", "T_CA_IM", "F_CA_IM", "R_CA_IM", "T_AL_CA_IM", "F_AL_CA_IM", "R_AL_CA_IM", "T_CA_IM_QT",
  "F_CA_IM_QT", "R_CA_IM_QT", "T_AL_CA_IM_QT", "F_AL_CA_IM_QT", "R_AL_CA_IM_QT", "T_CA_IM_YT", "F_CA_IM_YT",
  "R_CA_IM_YT", "T_AL_CA_IM_YT", "F_AL_CA_IM_YT", "R_AL_CA_IM_YT", "T_TL_CA_IM_UT", "F_TL_CA_IM_UT",
  "R_TL_CA_IM_UT", "T_CA_IM_UT", "F_CA_IM_UT", "R_CA_IM_UT", "T_AL_CA_IM_UT", "F_AL_CA_IM_UT", "R_AL_CA_IM_UT",
  "F_RT_QT", "F_AR_RT_QT", "T_RT_QT", "T_AR_RT_QT", "R_RT_QT", "R_AR_RT_QT", "F_RT_YT", "F_AR_RT_YT",
  "T_RT_YT", "T_AR_RT_YT", "R_RT_YT", "R_AR_RT_YT", "T_VC_BB", "T_VC_AD", "T_VC_RL", "T_VC_CLM", "T_VC_EB", 
  "F_VC_BB", "F_VC_AD", "F_VC_RL", "F_VC_CLM", "F_VC_EB", "R_VC_BB", "R_VC_AD", "R_VC_RL", "R_VC_CLM",
  "R_VC_EB", "T_VC_BB_QT", "T_VC_AD_QT", "T_VC_RL_QT", "T_VC_CLM_QT", "F_VC_BB_QT", "F_VC_AD_QT", "F_VC_RL_QT",
  "F_VC_CLM_QT", "R_VC_BB_QT", "R_VC_AD_QT", "R_VC_RL_QT", "R_VC_CLM_QT", "T_VC_BB_YT", "T_VC_AD_YT",
  "T_VC_RL_YT", "T_VC_CLM_YT", "F_VC_BB_YT", "F_VC_AD_YT", "F_VC_RL_YT", "F_VC_CLM_YT", "R_VC_BB_YT", 
  "R_VC_AD_YT", "R_VC_RL_YT", "R_VC_CLM_YT", "T_VC_UN", "F_VC_UN", "R_VC_UN", "T_VC_PS", "F_VC_PS", 
  "R_VC_PS", "T_TL_VC_UT", "F_TL_VC_UT", "R_TL_VC_UT", "PAYABLES_ACCT_FLAG", "LT_T_BAL", "LT_F_BAL", "LT_R_BAL") AS 
  WITH RPRO_RI_ACCT_GRP_VM AS (SELECT /*+ MATERIALIZE RESULT_CACHE */
                                  id,name,def_rec_flag,vc_flag,vc_clr_flag,client_id,incl_netting_flag,incl_manual_je_flag,cost_flag,acct_group,payables_acct_flag FROM RPRO_RI_ACCT_GRP_V),
     RPRO_CALENDAR_V AS (SELECT /*+ MATERIALIZE RESULT_CACHE */ ID,period_num,period_name,period_year,qtr_num,start_date,end_date, qtr_start_dt,qtr_end_dt,year_start_dt,year_end_dt,client_id from rpro_calendar_g)
SELECT
/**************************************************************************************************
...
--UTD
,CASE WHEN ACG.DEF_REC_FLAG IN ('REC','EREC') THEN NVL(F_AT_UT,0) ELSE 0 END AS F_TL_AT_UT
...
--UTD
,CASE WHEN ACG.DEF_REC_FLAG IN ('REC','EREC') THEN NVL(T_AT_UT,0) ELSE 0 END AS T_TL_AT_UT
...
--UTD
,CASE WHEN ACG.DEF_REC_FLAG IN ('REC','EREC') THEN NVL(R_AT_UT,0) ELSE 0 END AS R_TL_AT_UT
